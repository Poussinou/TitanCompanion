...
public class AdventureCombatFragment extends AdventureFragment {
    ...
    protected void init() {
        ...
        AdventureFragment fragment = this;
        ...
        testLuckButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (draw || luckTest)
                    return;
                luckTest = true;
                boolean result = adv.state.checkLuck();
                if (result) {
                    ...
                    if (hit) {
                        ...
                        adv.performIncreaseStamina(fragment);
                        staminaLoss--;
                    }
                } else {
                    ...
                    if (hit) {
                        ...
                        adv.performDecreaseStamina(fragment, 1);
                        staminaLoss++;
                    }

                    if (getKnockoutStamina() != null && adv.state.getCurrentStamina() <= getKnockoutStamina()) {
                        Adventure.Companion.showAlert(getString(R.string.knockedOut), adv);
                    }

                    if (adv.state.getCurrentStamina() == 0) {
                        onPlayerDeath(adv);
                    }
                }
                refreshScreen();
    ...
    protected void sequenceCombatTurn() {
        ...
        if (attackStrength > enemyAttackStrength) {
            ...
            adv.performDecreaseStamina(this, damage);
